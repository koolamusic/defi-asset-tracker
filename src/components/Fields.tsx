...
import { FormControl, FormLabel, IconButton, Input, InputProps, InputGroup, InputRightElement } from '@chakra-ui/react';
...
export const InputField: React.FC<RHInputProps> = (props): JSX.Element => {
    const { type, name, placeholder, withAction, actionIcon, actionHandler, label, register, required, ...rest } = props;
