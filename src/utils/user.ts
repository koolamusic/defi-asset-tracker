...
export const redirect = (ctx: NextPageContext, target = config.loginRoute) => {
  if (ctx.res) {
...
export const loginUser = async (payload: UserAccountDict, target = config.rootRoute) => {
...
export const logoutUser = (ctx: NextPageContext | null, target = config.loginRoute) => {
